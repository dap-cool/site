                        ...
                        Ok ( global, maybeListener ) ->
                            ...
                            case global of
                                Global.WalletMissing ->
                                    case model.state of
                                        Valid _ (State.Create creator) ->
                                            ( { model | state = Valid global <| State.Create creator }
                                            , Cmd.none
                                            )

                                        Valid _ (State.Collect collector) ->
                                            ( { model | state = Valid global <| State.Collect collector }
                                            , Cmd.none
                                            )
